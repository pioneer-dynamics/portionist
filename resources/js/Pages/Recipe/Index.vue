                    ...
                    <FlatForm @submitted="findRecipes">
                        ...
                        <PrimaryButton :disabled="form.processing" >
                            <span v-if="form.processing">
                                <div role="status">
                                    <svg aria-hidden="true" class="mx-3.5 w-4 h-4 text-gray-200 animate-spin dark:text-gray-800 fill-branding-green-900" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
